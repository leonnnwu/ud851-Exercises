...
public class ReminderTasks {
    ...
    public static final String ACTION_CHARING_REMINDER_NOTIFICATION = "charging-reminder-notification";
    ...
    public static void executeTask(Context context, String action) {
        ...
        } else if (ACTION_CHARING_REMINDER_NOTIFICATION.equals(action)) {
