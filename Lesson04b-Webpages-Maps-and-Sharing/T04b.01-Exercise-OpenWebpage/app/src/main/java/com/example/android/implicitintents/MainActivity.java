...
public class MainActivity extends AppCompatActivity {
    ...
    private void openWebPage(String queryLink) {
        Uri queryUri = Uri.parse(queryLink);
        Intent startWebActivity = new Intent(Intent.ACTION_VIEW, queryUri);
        if(startWebActivity.resolveActivity(getPackageManager()) !=  null) {
